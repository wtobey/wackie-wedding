...
export default function PhotoManager() {
  ...
  return <div className={styles.manager}>
    ...
    <p>Use Move up and Move down to arrange photos. Only photos with a date appear in the gallery. Undated photos stay in this manager. Excluded photos stay in this manager.</p>
