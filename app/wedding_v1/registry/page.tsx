...
export default function WeddingRegistry() {
  return <div className={styles.pageWrap}>
    <div className={styles.pageIntro}>
      ...
      <a className={styles.textLink} data-wedding-event="registry_clicked" href="https://www.williams-sonoma.com/registry/82qgb5s5d8/registry-list.html" target="_blank" rel="noreferrer" style={{ marginTop: "24px" }}>Williams Sonoma</a>
    </div>
  </div>;
}
